...
export const GENERAL = {
    ...
    ACCESS_TOKEN_MAX_AGE: 604800, //two weeks
    VENDOR_PORTAL_URL : "https://vendors.tovfurniture.com"
};

export const ETA_GENERAL = {
    /*AUTHOR : 5975,
    MAPPING_ID : 252,
    FOLDER: 283565,
    ...
    /*QUANTITY_BETWEEN_READY_AND_DEPARTURE : 5,
    TOV_REP_INDIAN_VENDOR : 74126,
    COUNTRY_MANAGER_ROLE : 1046*/
};
...
export const RENEGADE_LOGO_URL = runtime.envType == runtime.EnvType.SANDBOX ? "/core/media/media.nl?id=2808385&c=4057217_SB1&h=9a63b90e42929ac96c6e" : "/core/media/media.nl?id=2767799&c=4057217&h=34b43011526b9dd5da11";

// Values
export const VENDOR_OR_TOV_TEXT = {
    TOV : "TOV",
    VENDOR : "Vendor"
};
...
export const TITLE_DATA_BY_CATEGORY = {
    [PAGES_IDS.PENDING_VENDOR] : {
        TITLE : "Pending Vendor Action",
        ICON_CLASS : "fas fa-industry"
    },
    [PAGES_IDS.PENDING_TOV] : {
        TITLE : "Pending TOV Action",
        ICON_CLASS : ""
    },
    [PAGES_IDS.PENDING_PI] : {
        TITLE : "Pending PI File",
        ICON_CLASS : "far fa-file"
    },
    [PAGES_IDS.PENDING_LOAD_PLAN] : {
        TITLE : "Pending Load Plan",
        ICON_CLASS : "far fa-file"
    },
    [PAGES_IDS.LOAD_PLANS] : {
        TITLE : "Load Plans",
        ICON_CLASS : "fas fa-ship"
    },
    [PAGES_IDS.APPROVED_ORDERS] : {
        TITLE : "Approved Orders",
        ICON_CLASS : "fas fa-check"
    },
    [PAGES_IDS.PARTS_ORDERS] : {
        TITLE : "Parts Orders",
        ICON_CLASS : "fas fa-check"
    },
    [PAGES_IDS.RESET_PASSWORD] : {
    ...
    [PAGES_IDS.CREATE_LOAD_PLAN] : {
        TITLE : "Create Load Plans",
        ICON_CLASS : "fas fa-ship"
    },
};

export const FILE_TITLE_BY_ID = {
...
export const PURCHASE_ORDER_STATUSES_TEXT = {
    [PURCHASE_ORDER_STATUSES.DRAFT] : "Draft",
    [PURCHASE_ORDER_STATUSES.VENDOR_ACTION] : "Vendor Action",
    [PURCHASE_ORDER_STATUSES.TOV_ACTION] : "TOV Action",
    [PURCHASE_ORDER_STATUSES.PENDING_LOAD_PLAN] : "Pending Load Plan",
    [PURCHASE_ORDER_STATUSES.APPROVED] : "Approved",
    [PURCHASE_ORDER_STATUSES.PARTS_ORDERED] : "Parts Ordered",
    [PURCHASE_ORDER_STATUSES.DEPOSIT_PAID] : "Deposit Paid"
};
...
export const APPROVAL_REQUEST_COMMENTS = {
...
export const APPROVAL_REQUEST_LINES = {
...
export const APPROVAL_REQUEST_EMAIL = {
...
export const VENDOR_ETA_EMAIL_SENT = {
...
export const DELAY_TYPE_LIST = {
    ID : "customlist_mw_delay_types",
};

export const PO_TO_UPDATE_RECORD = {
...
// Objects used
export const PURCHASE_ORDER_OBJECT = {
    TRANID : "tranid",
    SUBTOTAL : "subtotal",
...
export const APPROVAL_REQUEST_OBJECT = {
    INTERNALID : "internalid",
    DATE : "date",
    PAGE_LINK : "page_link",
...
export const APPROVAL_REQUEST_LINES_OBJECT = {
    TRANID : "tranid",
    VENDOR_NAME : "vendor_name",
    VENDOR_ID : "vendor_id",
    ITEMS : "items",
...
export const INBOUND_SHIPMENT_OBJECT = {
