 ...
 */
define(["require", "exports", "N/log", "N/search", "N/task", "N/runtime", "../../Constants/Constants"], function (require, exports, log, search, task, runtime, constants) {
    Object.defineProperty(exports, "__esModule", { value: true });
    function updatePayments(pData) {
        var searchImport = search
            .create({
        ...
        if (searchImport && searchImport.length > 0) {
            ...
            log.debug("Checkbox Value", "Invoice " + pData.parameters["check_box_invoice"] + " and Sales Orders " + pData.parameters["check_box_sales_orders"]);
            // Validate checkbox
            if (pData.parameters["check_box_invoice"] === "F" && pData.parameters["check_box_sales_orders"] === "F") {
                ...
                try {
                    ...
                    var newFile = pData.files["csv_file"];
